...
export const metadata: Metadata = {
  title: "Pricing — Comptia Security Premium",
  description: "Unlock unlimited Comptia Security practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=comptia-security&cadence=annual`;
