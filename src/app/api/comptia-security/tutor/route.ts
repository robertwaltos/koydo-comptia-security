...
const EXAM_ID = "comptia-security";
const EXAM_DISPLAY_NAME = "CompTIA Security+ (SY0-701)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover general security concepts, threats/vulnerabilities/mitigations, security architecture, operations, and program management/oversight. Align to CompTIA Security+ SY0-701 objectives.
