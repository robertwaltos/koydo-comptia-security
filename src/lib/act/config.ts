// Auto-generated shim — re-exports from @/lib/comptia-security/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _comptia_security_Config } from "@/lib/comptia-security/config";
import { EXAM_CONFIG as _raw } from "@/lib/comptia-security/config";
